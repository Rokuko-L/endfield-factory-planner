// AUTO-GENERATED by generate-data.mjs from scraped/reports/.
// The reports are hand-curated from the wiki. Re-curate the
// reports and re-run this script to refresh the data model.
...
/** Miner: extracts raw ore from a node. Placeholder used by the test suite. */
...
/** Furnace: a 5x5 machine that takes an item on the south edge and outputs an item on the north edge. Placeholder used by the test suite. */
